...
/**
 * Register a broadcast driver that always fails, mimicking an unreachable websocket server (Nightwatch issue #30). The
 * chat broadcast events are queued, but on the sync queue used in tests they resolve inline, so this exercises the
 * worst case: the broadcaster throwing during the request.
 */
